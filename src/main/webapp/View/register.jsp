...
<form class="flex flex-col bg-white rounded shadow-lg p-12 mt-12" action="">
    <label class="font-semibold text-xs" for="usernameField">Correo</label>
    <input class="flex items-center h-6 px-4 w-64 bg-gray-200 mt-2 rounded focus:outline-none focus:ring-2"
           type="email">
    <label class="font-semibold text-xs mt-3" for="passwordField">Contraseña</label>
    <input class="flex items-center h-6 px-4 w-64 bg-gray-200 mt-2 rounded focus:outline-none focus:ring-2"
           type="password">
    <label class="font-semibold text-xs" for="usernameField">Correo</label>
    <input class="flex items-center h-6 px-4 w-64 bg-gray-200 mt-2 rounded focus:outline-none focus:ring-2"
